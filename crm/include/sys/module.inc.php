...
function module_install () {
    ...
    if (module_core_installed()) {
        error_register('The database must be empty before you can install ' . title() . '!');
        return false;
    }
...
function command_module_install () {
    ...
    message_register(title() . ' has been installed.');
...
function command_module_upgrade () {
    ...
    message_register(title() . ' has been upgraded.');
    return crm_url();
}
